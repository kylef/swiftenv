...
latex_documents = [
    (master_doc, 'swiftenv.tex', u'swiftenv Documentation',
...
man_pages = [
    (master_doc, 'swiftenv', u'swiftenv Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'swiftenv', u'swiftenv Documentation',
     author, 'swiftenv', 'One line description of project.',
     'Miscellaneous'),
]
